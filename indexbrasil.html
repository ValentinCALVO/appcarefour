...
.carousel-container {
        ...
        .carousel-slide img {
            width: 100%;
            height: 100%;
            object-fit: cover; /* Adapter l'image sans déformation */
        }
        ...
        .carousel-banner {
            ...
            top: 0;
            width: 100%;
            background: rgba(0, 0, 0, 0.5); /* Bannière sombre avec effet de transparence */
            color: white;
            padding: 10px;
            box-sizing: border-box;
            text-align: center;
   ...
   <div class="top-bar">
    ...
    <div class="nav-bar">
        <div class="nav-container">
           <a href="/appcarefour/index.html" class="active">À la une</a>
            <a href="/appcarefour/accueil.html">Accueil</a>
            <a href="/appcarefour/equipe.html">Équipe</a>
            <a href="/appcarefour/communaute.html">Forum</a>
            <a href="/appcarefour/planning.html">Planning</a>
            <a href="/appcarefour/ressources.html">Ressources</a>
            <a href="/appcarefour/sante.html">Santé</a>
            <a href="/appcarefour/support.html">Support</a>
        </div>
    </div>
    <div class="container">
    <p data-key="health_wellness_desc" align="center">Bienvenue sur la page à la une ! Ici, vous trouverez les dernières nouveautés et les programmes les plus en vogue. Nous avons regroupé les meilleures offres, les sessions à ne pas manquer et les actualités essentielles. Explorez notre sélection exclusive et restez informé des tendances pour maximiser votre expérience !</p>
        <!-- Suivi de la Santé et du Bien-Être -->
        <div class="section card">
            <h2 data-key="health_wellness">Les programmes à la une</h2>
              <div class="carousel-container">
        <div class="carousel-slide">
            <div class="carousel-item">
                <img src="https://valentincalvo.github.io/appcarefour/PS1.png" alt="Image 1">
            </div>
            <div class="carousel-item">
                <img src="https://valentincalvo.github.io/appcarefour/PS2.png" alt="Image 2">
            </div>
            <div class="carousel-item">
                <img src="https://valentincalvo.github.io/appcarefour/PS3.png" alt="Image 3">
            </div>
            <div class="carousel-item">
                <img src="https://valentincalvo.github.io/appcarefour/PS4.png" alt="Image 3">
            </div>
        </div>
        <div class="carousel-banner">
            <a href="#" id="carousel-link">En savoir plus</a>
        </div>
...
const slide = document.querySelector('.carousel-slide');
        ...
        const links = [
            { url: 'lien1.html', text: 'En savoir plus' },
            { url: 'lien2.html', text: 'En savoir plus' },
            { url: 'lien3.html', text: 'En savoir plus' },
            { url: 'lien4.html', text: 'En savoir plus' }
        ];
        ...
        function updateCarousel() {
            ...
            navButtons[counter].classList.add('active');
            carouselLink.href = links[counter].url;
            carouselLink.textContent = links[counter].text;
        }
        ...
        // Initial update to set the first button active
        updateCarousel();
    </script>
</body>
</html>
