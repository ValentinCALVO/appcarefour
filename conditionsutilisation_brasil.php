...
<body>
  ...
  <p>Bienvenue sur Care'four, l'application dédiée au bien-être interculturel et intergénérationnel proposée par Carrefour Brésil. En utilisant notre application, vous acceptez les conditions suivantes. Veuillez les lire attentivement avant d'utiliser notre service.</p>
  
  <h3>1. Acceptation des conditions</h3>
  <p>En accédant à et en utilisant Care'four, vous acceptez de vous conformer aux présentes conditions d'utilisation et à toutes les lois et réglementations applicables. Si vous n'acceptez pas ces conditions, veuillez ne pas utiliser l'application.</p>
  
  <h3>2. Modifications des conditions</h3>
  <p>Nous nous réservons le droit de modifier ces conditions d'utilisation à tout moment. Les modifications seront publiées sur cette page avec une nouvelle date de mise à jour. Il est de votre responsabilité de consulter régulièrement ces conditions pour rester informé de tout changement. Votre utilisation continue de l'application après la publication des modifications constitue votre acceptation des nouvelles conditions.</p>
  
  <h3>3. Utilisation de l'application</h3>
  <p>Vous vous engagez à utiliser Care'four uniquement à des fins légales et conformément à ces conditions. Vous ne devez pas :</p>
  <ul>
    <li>Utiliser l'application de manière à violer les lois locales, nationales ou internationales.</li>
    <li>Perturber ou interférer avec le bon fonctionnement de l'application.</li>
    <li>Accéder ou tenter d'accéder aux systèmes de Care'four sans autorisation.</li>
    <li>Utiliser l'application pour diffuser des contenus illégaux, offensants ou nuisibles.</li>
  </ul>
  
  <h3>4. Création de compte</h3>
  <p>Pour accéder à certaines fonctionnalités de Care'four, vous devrez créer un compte. Vous êtes responsable de la confidentialité de vos informations de connexion et de toutes les activités effectuées sous votre compte. Vous devez nous informer immédiatement en cas de toute utilisation non autorisée de votre compte.</p>
  
  <h3>5. Propriété intellectuelle</h3>
  <p>Tous les contenus présents sur Care'four, y compris les textes, graphiques, logos, images et logiciels, sont la propriété de Carrefour Brésil ou de ses partenaires et sont protégés par les lois sur la propriété intellectuelle. Vous ne pouvez pas reproduire, distribuer ou créer des œuvres dérivées de ces contenus sans autorisation préalable.</p>
  
  <h3>6. Responsabilité</h3>
  <p>Care'four est fourni « en l'état » et nous ne garantissons pas que l'application sera exempte d'erreurs ou de bugs. Nous ne serons pas responsables des dommages directs, indirects, accidentels, spéciaux ou consécutifs résultant de l'utilisation ou de l'incapacité à utiliser l'application.</p>
  
  <h3>7. Liens vers des sites tiers</h3>
  <p>Care'four peut contenir des liens vers des sites Web ou des services tiers. Nous ne contrôlons pas ces sites et ne sommes pas responsables de leur contenu ou de leurs pratiques en matière de confidentialité. L'accès à ces sites est à vos propres risques.</p>
  
  <h3>8. Résiliation</h3>
  <p>Nous nous réservons le droit de suspendre ou de résilier votre accès à Care'four si nous constatons une violation de ces conditions d'utilisation. En cas de résiliation, vous devez cesser immédiatement toute utilisation de l'application.</p>
  
  <h3>9. Loi applicable</h3>
  <p>Ces conditions d'utilisation sont régies par les lois du Brésil. Tout litige découlant de l'utilisation de Care'four sera soumis à la compétence exclusive des tribunaux de São Paulo, SP, Brésil.</p>
  
  <h3>10. Contact</h3>
  <p>Pour toute question concernant ces conditions d'utilisation, veuillez nous contacter à l'adresse suivante :</p>
  <address>
  ...
  <p>Merci d'utiliser Care'four. Nous espérons que notre application contribuera positivement à votre bien-être interculturel et intergénérationnel.</p>
           </div>
    </div>
      <div class="footer">
