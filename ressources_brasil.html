   ...
   <div class="top-bar">
    ...
    <div class="nav-bar">
        <div class="nav-container">
           <a href="/appcarefour/index_brasil.html">À la une</a>
            ...
            <a href="/appcarefour/ressources_brasil.html" class="active">Ressources</a>
    ...
    <div class="container">
        <div class="section card">
            <div class="notebook">
        <header>
            <h1>Ressources pour votre bien-être</h1>
            <p>Explorez notre sélection de ressources pour vous aider à améliorer votre bien-être.</p>
        </header>
        ...
        <section class="webinars">
            ...
            <div class="resource-list">
                <article>
                    <h3><a href="https://example.com/webinaire1" target="_blank">Gestion du stress au quotidien</a></h3>
                    <p>Découvrez des techniques efficaces pour gérer le stress et améliorer votre qualité de vie.</p>
                </article>
                <article>
                    <h3><a href="https://example.com/webinaire2" target="_blank">Alimentation équilibrée pour une vie saine</a></h3>
                    <p>Apprenez comment une alimentation équilibrée peut influencer positivement votre bien-être.</p>
                </article>
                <article>
                    <h3><a href="https://example.com/webinaire3" target="_blank">Mindfulness et méditation</a></h3>
                    <p>Participez à une session sur les pratiques de mindfulness pour renforcer votre sérénité intérieure.</p>
                </article>
            </div>
        </section>
        ...
        <section class="articles">
            ...
            <div class="resource-list">
                <article>
                    <h3><a href="https://example.com/article1" target="_blank">Les bienfaits de la méditation</a></h3>
                    <p>Un aperçu approfondi des avantages mentaux et physiques de la méditation régulière.</p>
                </article>
                <article>
                    <h3><a href="https://example.com/article2" target="_blank">Comment créer un espace de relaxation à la maison</a></h3>
                    <p>Conseils pratiques pour aménager un espace de détente et favoriser le bien-être à domicile.</p>
                </article>
                <article>
                    <h3><a href="https://example.com/article3" target="_blank">L'importance du sommeil pour la santé mentale</a></h3>
                    <p>Des stratégies pour améliorer la qualité de votre sommeil et ses impacts sur la santé mentale.</p>
                </article>
            </div>
        </section>
        ...
        <section class="videos">
            ...
            <div class="resource-list">
                <article>
                    <h3><a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank">Séance de yoga matinale</a></h3>
                    <p>Une séance guidée pour commencer votre journée avec énergie et calme.</p>
                </article>
                <article>
                    <h3><a href="https://www.youtube.com/watch?v=3h1sG0osrZ0" target="_blank">Techniques de relaxation</a></h3>
                    <p>Des techniques de relaxation pour soulager la tension et retrouver la sérénité.</p>
                </article>
                <article>
                    <h3><a href="https://www.youtube.com/watch?v=1w7c7xYpC8Y" target="_blank">Recettes de smoothies pour le bien-être</a></h3>
                    <p>Des recettes de smoothies sains pour un boost nutritionnel rapide et savoureux.</p>
                </article>
            </div>
        </section>
        ...
        <section class="podcasts">
            ...
            <div class="resource-list">
                <article>
                    <h3><a href="https://example.com/podcast1.mp3" target="_blank">Épisode 1: Introduction à la pleine conscience</a></h3>
                    <p>Un épisode pour vous introduire aux principes de la pleine conscience et ses bénéfices.</p>
                </article>
                <article>
                    <h3><a href="https://example.com/podcast2.mp3" target="_blank">Épisode 2: Alimentation et bien-être</a></h3>
                    <p>Discussion sur l'impact de l'alimentation sur le bien-être général et la santé.</p>
                </article>
                <article>
                    <h3><a href="https://example.com/podcast3.mp3" target="_blank">Épisode 3: Techniques avancées de gestion du stress</a></h3>
                    <p>Techniques et conseils pour gérer le stress de manière plus efficace et durable.</p>
                </article>
            </div>
        </section>
    </div>
