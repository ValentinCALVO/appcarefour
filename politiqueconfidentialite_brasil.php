    ...
    <div class="nav-bar">
        <div class="nav-container">
           <a href="/appcarefour/index_brasil.html">À la une</a>
            ...
            <a href="/appcarefour/support_brasil.html">Support</a>
        </div>
    </div>
    <div class="container">
        <div class="section card">
        <h2>Politique de confidentialité</h2>
  <p><strong>Dernière mise à jour : 24 juillet 2024</strong></p>
  
  <p>Bienvenue sur Care'four, l'application dédiée au bien-être interculturel et intergénérationnel proposée par Carrefour Brésil. Nous nous engageons à protéger votre vie privée et à garantir la sécurité de vos données personnelles. Cette politique de confidentialité explique comment nous recueillons, utilisons, partageons et protégeons vos informations lorsque vous utilisez notre application.</p>
  
  <h3>1. Collecte des informations</h3>
  <p>Nous collectons les informations suivantes lorsque vous utilisez Care'four :</p>
  <ul>
    <li><strong>Informations personnelles</strong> : Nom, prénom, adresse e-mail, date de naissance, et autres informations similaires que vous fournissez volontairement.</li>
    <li><strong>Informations d’utilisation</strong> : Données sur votre utilisation de l'application, y compris vos préférences, les sections que vous visitez et les fonctionnalités que vous utilisez.</li>
    <li><strong>Informations techniques</strong> : Adresse IP, type de navigateur, système d'exploitation, données de géolocalisation, et autres informations liées à votre appareil.</li>
  </ul>
  
  <h3>2. Utilisation des informations</h3>
  <p>Nous utilisons les informations collectées pour :</p>
  <ul>
    <li><strong>Améliorer l'application</strong> : Personnaliser votre expérience et adapter nos services à vos besoins.</li>
    <li><strong>Communiquer avec vous</strong> : Vous envoyer des notifications importantes concernant les mises à jour, les offres et les événements de Care'four.</li>
    <li><strong>Analyser les tendances</strong> : Effectuer des analyses pour améliorer nos services et comprendre comment les utilisateurs interagissent avec l'application.</li>
    <li><strong>Assurer la sécurité</strong> : Détecter et prévenir les fraudes, les abus et autres activités nuisibles.</li>
  </ul>
  
  <h3>3. Partage des informations</h3>
  <p>Nous ne partageons vos informations personnelles avec des tiers que dans les situations suivantes :</p>
  <ul>
    <li><strong>Prestataires de services</strong> : Nous pouvons partager vos données avec des prestataires de services tiers qui nous aident à fournir et à améliorer l'application, à condition qu'ils respectent des normes de confidentialité strictes.</li>
    <li><strong>Obligations légales</strong> : Nous pouvons divulguer vos informations si la loi l'exige ou pour protéger nos droits et ceux de nos utilisateurs.</li>
    <li><strong>Consentement</strong> : Avec votre consentement explicite pour des finalités spécifiques.</li>
  </ul>
  
  <h3>4. Sécurité des données</h3>
  <p>Nous mettons en œuvre des mesures de sécurité appropriées pour protéger vos informations contre l'accès non autorisé, la divulgation, la modification et la destruction. Cependant, aucune méthode de transmission sur Internet ou de stockage électronique n'est complètement sécurisée. Nous nous efforçons de protéger vos données, mais nous ne pouvons garantir leur sécurité absolue.</p>
  
  <h3>5. Vos droits</h3>
  <p>Conformément aux lois applicables en matière de protection des données, vous avez les droits suivants :</p>
  <ul>
    <li><strong>Accès et correction</strong> : Vous pouvez accéder à vos informations personnelles et demander leur correction si elles sont inexactes.</li>
    <li><strong>Suppression</strong> : Vous pouvez demander la suppression de vos informations personnelles, sous réserve des obligations légales ou contractuelles.</li>
    <li><strong>Opposition</strong> : Vous pouvez vous opposer à l'utilisation de vos informations personnelles à des fins spécifiques.</li>
  </ul>
  <p>Pour exercer vos droits ou poser des questions concernant cette politique, veuillez nous contacter à l'adresse suivante : <a href="mailto:appcarefour@support.carrefour.br">appcarefour@support.carrefour.br</a>.</p>
  
  <h3>6. Modifications de la politique</h3>
  <p>Nous pouvons mettre à jour cette politique de confidentialité de temps à autre. Les modifications seront publiées sur cette page avec une nouvelle date de mise à jour. Nous vous encourageons à consulter régulièrement cette politique pour rester informé de tout changement.</p>
  
  <h3>7. Contact</h3>
  <p>Pour toute question ou préoccupation concernant cette politique de confidentialité ou le traitement de vos informations personnelles, veuillez nous contacter à :</p>
  <address>
    Care'four - Carrefour Brésil<br>
    Rua do Exemplo, 456, São Paulo, SP, Brésil<br>
    Email : <a href="mailto:appcarefour@support.carrefour.br">appcarefour@support.carrefour.br</a><br>
    Téléphone : +55 11 98765-4321
  </address>
  
  <p>Nous vous remercions d'utiliser Care'four et de nous faire confiance pour votre bien-être interculturel et intergénérationnel.</p>
           </div>
    </div>
      <div class="footer">
