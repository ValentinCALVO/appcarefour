...
<body>
   <div class="top-bar">
    ...
    <div class="container">
        ...
        <section class="card">
            <h2>Introduction</h2>
            <p>Nous vous accueillons sur notre site où vous pouvez trouver toutes les informations sur nos services et notre entreprise. Explorez les différentes sections pour en savoir plus sur ce que nous faisons et comment nous pouvons vous aider.</p>
        </section>
        <section class="card">
            <h2>Actualités</h2>
            <p>Restez à jour avec les dernières nouvelles et les événements à venir. Consultez régulièrement cette section pour ne rien manquer de ce qui se passe chez nous.</p>
        </section>
    </div>
           </div>
    </div>
