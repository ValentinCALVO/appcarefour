...
@media (max-width: 768px) {
 ...
 /* Styles spécifiques pour le forum */
        .forum-section {
            margin-bottom: 30px;
        }
        .forum-category {
...
<body>
   <div class="top-bar">
    ...
    <div class="nav-bar">
        <div class="nav-container">
           <a href="/appcarefour/index_brasil.html">À la une</a>
            ...
            <a href="/appcarefour/communaute_brasil.html" class="active">Forum</a>
    ...
    <div class="container">
        ...
        <!-- Section Bien-être -->
        <section id="bien-etre" class="forum-section">
            <div class="forum-category">
                <h2>Bien-être : Astuces pour une vie équilibrée</h2>
                <div class="forum-post">
                    <div class="username">SophieL_28</div>
                    <div class="content">Pour maintenir un équilibre dans la vie, il est crucial de consacrer du temps à la relaxation et à des activités que l'on aime. La méditation et les promenades en nature sont des pratiques excellentes pour le bien-être mental.</div>
                    <div class="actions">
                        <button onclick="likePost(this)">J'aime</button>
                        <button onclick="toggleComments(this)">Commenter</button>
                    </div>
        ...
        <!-- Section Interculturel -->
        <section id="interculturel" class="forum-section">
            <div class="forum-category">
                <h2>Interculturel : Expériences de voyage</h2>
                <div class="forum-post">
                    <div class="username">LucaB_45</div>
                    <div class="content">Voyager m'a permis de découvrir des cultures fascinantes. La nourriture, les traditions et les langues sont des aspects incroyablement enrichissants. Quel est votre pays préféré pour une expérience interculturelle ?</div>
                    <div class="actions">
                        <button onclick="likePost(this)">J'aime</button>
                        <button onclick="toggleComments(this)">Commenter</button>
                    </div>
        ...
        <!-- Section Intergénérationnel -->
        <section id="intergenerationnel" class="forum-section">
            <div class="forum-category">
                <h2>Intergénérationnel : Activités à partager en famille</h2>
                <div class="forum-post">
                    <div class="username">JeanM_82</div>
                    <div class="content">Passer du temps en famille est essentiel pour renforcer les liens intergénérationnels. Des activités comme la cuisine ensemble, les jeux de société ou les promenades sont parfaites pour toutes les générations.</div>
                    <div class="actions">
                        <button onclick="likePost(this)">J'aime</button>
                        <button onclick="toggleComments(this)">Commenter</button>
                    </div>
    ...
    <div class="footer-content">
        ...
        <p><a href="#" data-key="footer_privacy"></a> | <a href="#" data-key="footer_terms"></a></p>
 ...
 // Fonction de recherche des posts
        ...
        function sortPosts() {
            ...
            const posts = Array.from(container.querySelectorAll('.forum-post'));
            posts.sort((a, b) => {
        ...
        function likePost(button) {
            ...
            let likes = parseInt(post.dataset.likes) || 0;
            likes++;
            post.dataset.likes = likes;
            button.textContent = `J'aime (${likes})`;
        }
        ...
        function addComment(button) {
            ...
            if (commentText) {
                ...
                newComment.classList.add('forum-post');
                newComment.innerHTML = `<div class="username">NouveauCommentateur</div>
                ...
                button.parentElement.parentElement.parentElement.appendChild(newComment);
                textarea.value = '';
            }
        }
        ...
        function sendMessage() {
            ...
            if (messageText) {
                ...
                const userMessage = document.createElement('div');
                userMessage.textContent = `Vous: ${messageText}`;
                messages.appendChild(userMessage);
                input.value = '';
                // Simuler une réponse du chatbot
                setTimeout(() => {
                    const botMessage = document.createElement('div');
                    botMessage.textContent = `Chatbot: Merci pour votre message !`;
