   ...
   <div class="top-bar">
    ...
    <div class="nav-bar">
        <div class="nav-container">
            ...
            <a href="/appcarefour/equipe_brasil.html" class="active">Équipe</a>
    ...
    <div class="container">
        <div class="section card">
         <section class="team-members">
                <h2>Pôle développement de l'application</h2>
                <div class="team-grid">
                    <div class="team-member">
                        <div class="profile-container">
                            <img src="https://media.licdn.com/dms/image/D4E03AQGMAjc_HfAy2w/profile-displayphoto-shrink_400_400/0/1719822220925?e=1727308800&v=beta&t=N4yoR33RuGtg-7oMH6GEf3tiXRuD65Qcwy7qqQOT2wg"" alt="Photo de Valentin CALVO" class="profile-pic">
                        </div>
                        <div class="member-info">
                            <p class="name">Valentin CALVO</p>
                            <p class="role">Chef de projet</p>
                            <div class="speech-bubble">
                                <p>Je supervise le développement et la coordination de l'équipe pour garantir le succès du projet.</p>
                            </div>
                        </div>
                    </div>
                    <div class="team-member">
                        <div class="profile-container">
                        	<img src="https://media.licdn.com/dms/image/D4E03AQHWx-hiYpa2cQ/profile-displayphoto-shrink_400_400/0/1694609558429?e=1727308800&v=beta&t=baH13hgK3CX3-bG5R5VhGgx5aMXIpHcje3W2Gg1snP8" alt="Photo de Flavien CEDE" class="profile-pic">
                        </div>
                        <div class="member-info">
                            <p class="name">Flavien CEDE</p>
                            <p class="role">Développeur front-end</p>
                            <div class="speech-bubble">
                                <p>Je m'assure que l'interface utilisateur soit attrayante et facile à utiliser.</p>
                            </div>
                        </div>
                    </div>
                    <div class="team-member">
                        <div class="profile-container">
                            <img src="/appcarefour/photoprofil_Nazookh.jpeg" alt="Photo de Nazookh NUJURALLY" class="profile-pic">
                        </div>
                        <div class="member-info">
                            <p class="name">Nazookh NUJURALLY</p>
                            <p class="role">Développeur back-end</p>
                            <div class="speech-bubble">
                                <p>Je travaille sur la logique serveur, les bases de données et la performance de l'application.</p>
                            </div>
                        </div>
                    </div>
                    <div class="team-member">
                        <div class="profile-container">
                            <img src="https://media.licdn.com/dms/image/D4E03AQGABy01b4vwfQ/profile-displayphoto-shrink_400_400/0/1698656380547?e=1727308800&v=beta&t=WxnVlV2KgS5FakxddFKgiHUHjdq7R5xWP_oBlET_ZZk" alt="Photo de Lola PETIT JEAN" class="profile-pic">
                        </div>
                        <div class="member-info">
                            <p class="name">Lola PETITJEAN</p>
                            <p class="role">Designer</p>
                            <div class="speech-bubble">
                                <p>Je crée des designs intuitifs et esthétiques pour améliorer l'expérience utilisateur.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="team-members">
                <h2>Pôles de support</h2>
                <div class="team-grid">
                    <div class="team-member">
                        <div class="profile-container">
                            <img src="https://www.shutterstock.com/image-vector/vector-flat-illustration-grayscale-avatar-600nw-2281862025.jpg" alt="Photo de Claire Lefevre" class="profile-pic">
                        </div>
                        <div class="member-info">
                            <p class="name">Claire LEFEVRE</p>
                            <p class="role">Responsable des ressources humaines</p>
                            <div class="speech-bubble">
                                <p>Je gère le recrutement, la formation et le bien-être des employés.</p>
                            </div>
                        </div>
                    </div>
                    <div class="team-member">
                        <div class="profile-container">
                            <img src="https://www.shutterstock.com/image-vector/vector-flat-illustration-grayscale-avatar-600nw-2281862025.jpg" class="profile-pic">
                        </div>
                        <div class="member-info">
                            <p class="name">Pierre BERNARD</p>
                            <p class="role">Responsable du service client</p>
                            <div class="speech-bubble">
                                <p>Je veille à ce que nos clients reçoivent un service exceptionnel et rapide.</p>
                            </div>
                        </div>
                    </div>
                    <div class="team-member">
                        <div class="profile-container">
                            <img src="https://www.shutterstock.com/image-vector/vector-flat-illustration-grayscale-avatar-600nw-2281862025.jpg" alt="Photo de Isabelle Dupuis" class="profile-pic">
                        </div>
                        <div class="member-info">
                            <p class="name">Isabelle DUPUIS</p>
                            <p class="role">Responsable de la communication</p>
                            <div class="speech-bubble">
                                <p>Je gère les communications internes et externes pour améliorer notre image de marque.</p>
                            </div>
                        </div>
                    </div>
                    <div class="team-member">
                        <div class="profile-container">
                            <img src="https://www.shutterstock.com/image-vector/vector-flat-illustration-grayscale-avatar-600nw-2281862025.jpg" alt="Photo de Jérôme Dubois" class="profile-pic">
                        </div>
                        <div class="member-info">
                            <p class="name">Jérôme DUBOIS</p>
                            <p class="role">Responsable des finances</p>
                            <div class="speech-bubble">
                                <p>Je supervise les finances de l'entreprise pour assurer sa santé financière.</p>
                            </div>
                        </div>
                    </div>
                </div>
